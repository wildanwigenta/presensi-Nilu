                ...
                <form method="POST" action="<?= base_url('admin/data_pegawai/update/'.$pegawai['id']) ?>"
                        ...
                        <div class="input-style-1">
                                ...
                                <div id="face_registration_container" class="border rounded p-3 mb-2"
                                        ...
                                        <div id="face_saved_status" class="text-success mt-2">
                                                <?= !empty($pegawai['face_descriptor']) ? 'Face descriptor sudah ada.' : '' ?>
                                        </div>
                                </div>
                                <input type="hidden" id="face_descriptor" name="face_descriptor" value="" />
                                <small class="text-secondary">Webcam akan aktif otomatis, dan sistem akan mendeteksi
                                        wajah secara realtime.</small>
                        </div>
